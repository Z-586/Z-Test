...
public:
    ...
    void setupUi(QDialog *Dialog_advanced)
    {
        ...
        Dialog_advanced->resize(506, 299);
...
"}"));
        ...
        pushButton_sendIP = new QPushButton(frameEthernet);
    ...
    void retranslateUi(QDialog *Dialog_advanced)
    {
        ...
        pushButton_sendIP->setText(QCoreApplication::translate("Dialog_advanced", "IP\345\222\214\347\253\257\345\217\243\351\205\215\347\275\256", nullptr));
