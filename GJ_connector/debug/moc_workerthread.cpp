...
QT_MOC_LITERAL(1, 13, 21), // "updateDynamicCaliData"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "WorkerThread\0updateDynamicCaliData\0"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateDynamicCaliData(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::updateDynamicCaliData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::updateDynamicCaliData()
{
